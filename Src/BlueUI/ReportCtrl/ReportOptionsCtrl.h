...
/////////////////////////////////////////////////////////////////////////////
// CReportOptionsDateTimeCtrl window

class CReportOptionsDateTimeCtrl : public CXTDateTimeCtrl
{
	DECLARE_DYNCREATE(CReportOptionsDateTimeCtrl)
...
// Overrides
public:
	virtual ~CReportOptionsDateTimeCtrl();
	...
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CReportOptionsDateTimeCtrl)
	public:
	virtual BOOL PreTranslateMessage(MSG* pMsg);
	//}}AFX_VIRTUAL
...
protected:
	...
	// Generated message map functions
protected:
	//{{AFX_MSG(CReportOptionsDateTimeCtrl)
	afx_msg void OnKillFocus(CWnd* pNewWnd);
	//}}AFX_MSG
...
public:
	...
	CString GetComboTextList(HTREEITEM hItem);
	int  ParseComboTextList(CString strText, CStringArray& aTextList);
...
protected:
	...
	// add by xieyongfang at 2002-04-01
	CReportOptionsDateTimeCtrl*	m_lpDateTimeCtrl;

	CStringArray m_asComboText;	// Combo字符串列表
	CUIntArray m_ahComboItem;	// Combo和TREEITEM的对应关系
	// add by xieyongfang at 2002-04-01 end
