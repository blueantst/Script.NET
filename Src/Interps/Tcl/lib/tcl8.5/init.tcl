...
#
# ActiveState ActiveTcl 8.5.9.0.293667 Win32/x86, Wed Sep 15 22:03:01 PDT 2010
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1284613381}
	buildtime,fmt {Wed Sep 15 22:03:01 PDT 2010}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.9.0.293667 Win32/x86 @ Wed Sep 15 22:03:01 PDT 2010 / normal}
    }
}

package provide {ActiveTcl} {8.5.9.0.293667}
