...
{
	// 在此添加属性页
	DLL_LOADSTRING(strTpsLuaInterp, IDS_TPS_LUA_INTERP);	// LUA解释器
	DLL_LOADSTRING(strTpsAboutLuaInterp, IDS_TPS_ABOUT_LUA_INTERP);	// 关于LUA解释器...
	VCI_REGISTER_PROPERTYPAGE("", strTpsLuaInterp, strTpsAboutLuaInterp, IDD_TPS_LUAINTERP, CTpsLuaInterp, 0);

	DLL_LOADSTRING(strTpsLuaComplie, IDS_TPS_LUA_COMPILE);	// 编译选项
	DLL_LOADSTRING(strTpsAboutLuaCompile, IDS_TPS_ABOUT_LUA_COMPILE);	// 设置Lua编译选项...
	VCI_REGISTER_PROPERTYPAGE(strTpsLuaInterp, strTpsLuaComplie, strTpsAboutLuaCompile, IDD_TPS_LUA_COMPILE, CTpsLuaCompile, 0);

	DLL_LOADSTRING(strTpsLuaBuild, IDS_TPS_LUA_BUILD);	// 构建选项
	DLL_LOADSTRING(strTpsAboutLuaBuild, IDS_TPS_ABOUT_LUA_BUILD);	// 设置Lua构建选项...
