...
body TLFAppPage::OnCreate {} {
	...
	if {[CheckInstalledInterpPackage] == -1} {
		...
		LangString STR_INFO english "You do not have any script language development kits, click on the link <a href='$url_download'>$url_download</a> can download and install."
